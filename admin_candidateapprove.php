...
<?php
    ...
    $sql="SELECT CandidateID,FirstName,MiddleName,LastName,PartyAffiliation,election.ElectionName, Age,Gender,CandidatePhoto
    from candidate inner join election on candidate.ElectionID=election.ElectionID where candidate.CandidateStatus='pending'";
...
<body>
    ...
    <div class="main">
        <div class="mini-nav">
            ...
            <a href="#"><span>Approve Candidate</span></a>
        </div>
                    ...
                    <?php if(count($data)>0){ ?>
                        <?php foreach($data as $key=>$record){ ?>    
                            <tr>
                                ...
                                <td class="action">
                                    <a href="candidate_enable.php?id=<?php echo $record['CandidateID'] ?>" class="edit" onclick="return confirm('Are you sure to approve this candidate?')">Approve</a>
                                     | <a href="candidate_disapprove.php?id=<?php echo $record['CandidateID'] ?>" class="delete" onclick="return confirm('Are you sure to disapprove this candidate?')">Dispprove</a>
                                </td>
                            </tr>
                        <?php } ?>
                    <?php } else {?>
