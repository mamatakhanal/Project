...
<?php
    ...
    $sql="SELECT ElectionID,ElectionName,ElectionDate from election where ElectionStatus='completed' order by ElectionDate desc";
    ...
    <div class="container">
        <div class="election-type">
            ...
            <div class="election-details election-list">
                <h2>Check out the completed elections</h2>
                    ...
                    <?php foreach($data as $key=>$record){ ?>
                        <div class="ele-list">
                            ...
                            <div class="box ele-name">
                                <a href="endcandidate.php?id=<?php echo $record['ElectionID'] ?>"><h2 style="padding-top: 20px;"><?php echo $record['ElectionName'] ?></h2></a>
                            </div>
                            <div>
                                <a href="result.php?id=<?php echo $record['ElectionID'] ?>"><p style="padding-top: 20px;">View Results<i class='bx bx-right-arrow-circle' ></i></p></a>
                            </div>
                        </div>
                    <?php } ?>
                <?php } else {?>
                    <h2>No completed elections</h2>
                <?php }?>
            </div>
        </div>
    </div>
