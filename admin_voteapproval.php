...
error_reporting(0);
    ...
    $sql="SELECT VoterID,FirstName,MiddleName,LastName,DateOfBirth,Gender,Address,Email from voter where VoterStatus='inactive'";
...
<body>
    ...
    <div class="main">
        <div class="mini-nav">
            <a href="admin_voterlist.php"><span>Active Voters</span></a>
            <a href="#"><span>Approve Voters</span></a>
        </div>
                    ...
                    <?php if(count($data)>0){ ?>
                        <?php foreach($data as $key=>$record){ ?>    
                            <tr>
                                ...
                                <td class="action">
                                    <a href="voter_enable.php?id=<?php echo $record['VoterID'] ?>" class="edit" onclick="return confirm('Are you sure to approve?')">Enable</a>
                                </td>
                            </tr>
                        <?php } ?>
                    <?php } else {?>
