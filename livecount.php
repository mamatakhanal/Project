...
<body>
    ...
    <div class="mini-nav">
        ...
        <a href="candidate.php?id=<?php echo $id ?>"><h4>View All Candidates <i class='bx bx-chevron-right-circle'></i></h4></a>
    </div>
    <h3 style="text-align: center;color:#332c58">LIVE COUNT</h3>
    <hr style="font-weight:bolder; width: 40%;padding:none; margin:auto;">
    <div class="container">
