...
<body>
    ...
    <div class="main">
        <div class="mini-nav">
            <a href="#"><span>Active Voters</span></a>
            <a href="admin_voteapproval.php"><span>Approve Voters</span></a>
        </div>
                    ...
                    <?php if(count($data)>0){ ?>
                        <?php foreach($data as $key=>$record){ ?>    
                            <tr>
                                ...
                                <td class="action">
                                    <a href="voter_disable.php?id=<?php echo $record['VoterID'] ?>" class="delete" onclick="return confirm('Are you sure to disable the voter?')">Disable</a>
                                </td>
                            </tr>
                        <?php } ?>
                    <?php } else {?>
